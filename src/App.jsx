...
const PRAISES = [
  ...
  "Tvoje cesta z cihel roste jedna radost!", "Skvělý postup!", "Bezva!", "Perfektní!",
];
...
const COMPLETE_MSGS = [
  ...
  "Úžasné! Stavba je hotová.",
  "Skvělá práce! Postavil(a) jsi ji celou.",
  ...
  return (
    <div style={{ position:"relative", zIndex:1, display:"flex", flexDirection:"column", alignItems:"center", minHeight:"100vh", padding:"36px 16px", gap:24 }}>
      ...
      <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:2 }}>
        <h1 style={{ fontSize:"clamp(22px,4vw,34px)", margin:0, textAlign:"center" }}>
          <span style={{ color:C.textMain, fontWeight:900 }}>Math</span>
          <span style={{ color:C.textSub, fontWeight:400 }}>Brick</span>
        </h1>
        <span style={{ color:C.accent, fontSize:15, fontWeight:700, letterSpacing:0.3, textTransform:"uppercase" }}>
          Počítej a stav
        </span>
      </div>
      <p style={{ color:C.textSub, fontSize:16, margin:0, textAlign:"center" }}>
        Vyber si příklad a sbírej cihly za správné odpovědi!
      </p>
      ...
      <Card style={{ maxWidth:480, width:"100%" }}>
        <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:16 }}>
          ...
          <div>
            ...
            <div style={{ fontSize:13, color:C.textSub }}>Procvičuj násobení — 10 příkladů, 10 cihel</div>
          </div>
        </div>
      ...
      <Card style={{ maxWidth:480, width:"100%" }}>
        <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:16 }}>
          ...
          <div>
            ...
            <div style={{ fontSize:13, color:C.textSub }}>Procvičuj dělení — 10 příkladů, 10 cihel</div>
          </div>
        </div>
      ...
      <p style={{ color:C.textSub, fontSize:13, opacity:0.7, textAlign:"center", margin:0 }}>
        Za každou správnou odpověď přibude cihla!
      </p>
    </div>
  );
}
    ...
    <div style={{ position:"relative", zIndex:1, display:"flex", flexDirection:"column", alignItems:"center", minHeight:"100vh", padding:"32px 16px", gap:20 }}>
      <Card style={{ maxWidth:420, width:"100%", textAlign:"center" }}>
        ...
        <p style={{ color:C.textSub, fontSize:15, margin:"0 0 20px" }}>
          Procvičil(a) jsi {modeLabel} a postavil(a) svoji stavbu!
        </p>
      ...
      {showHouse && (
        <Card style={{ maxWidth:320, width:"100%", padding:"16px 12px" }}>
          <div style={{ textAlign:"center", marginBottom:6, fontSize:12, fontWeight:700, color:C.textSub, textTransform:"uppercase", letterSpacing:0.5 }}>
            {buildingMeta.emoji} Tvoje dokončená stavba
          </div>
